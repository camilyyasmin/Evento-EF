...
namespace EventosEF.Controllers
{
    public class ParticipantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ParticipanteId,Nome,Email,Telefone")] Participante participante)
        {
            ...
            {
                participante.ParticipanteId = Guid.NewGuid();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ParticipanteId,Nome,Email,Telefone")] Participante participante)
        {
